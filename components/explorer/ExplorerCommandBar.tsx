...
/**
 * Single cryptic search field. Resolves a block number, tx hash, or address
 * and routes to the matching detail page. Wrong shapes flash an error glyph.
 */
export function ExplorerCommandBar() {
  ...
  return (
    ...
    >
      <span className="qb-label px-4 text-qb-mist">QUERY</span>
      <input
        value={q}
        onChange={(e) => setQ(e.target.value)}
        spellCheck={false}
        autoComplete="off"
        placeholder="block · 0x tx hash · 0x address"
        data-cursor="link"
